...
import Section4 from '@/app/components/caseStudies/Section4'

const SubCaseStudyDetails = ({  params  }) => {
  ...
  const { caseStudyId, subCaseStudyId } = params;
  console.log(subCaseStudyId, "id")
  const data = caseStudies?.find(study => study.id === caseStudyId);
  const subProjectData = data?.subProjects?.items?.find(study => study?.id === subCaseStudyId);

  console.log(subProjectData, "subProjectData")
  console.log(data, "data")
  if (!data | !subProjectData) {
  ...
  return (
    <div>
        <HeroSection data={subProjectData.heroSection} />
        <Section1 data={subProjectData.section1}/>
        <Section3  data={subProjectData.features[2]}/>
        <Section4  data={subProjectData.subProjects}/>
        <Section2  data={subProjectData.objectivesData}/>
        <Section3  data={subProjectData.features[0]}/>
        <Section2  data={subProjectData.challengesData}/>
        <Section3  data={subProjectData.features[1]}/>
        <Section2  data={subProjectData.keyResultsData}/>
        <Section3  data={subProjectData.conclusion}/>
...
export default SubCaseStudyDetails