...
const isActive = (path) => pathname === path;
  ...
  return (
    <header className="bg-black justify-center items-center flex-col transition-opacity duration-700  md:flex-row flex w-full text-white pt-4 pb-5 sticky z-20 top-0 shadow-md">
      ...
      <div className="container mx-auto flex justify-between  items-center">
        ...
        <nav className="hidden md:flex justify-center items-center space-x-6">
          <Link href="/services" className={` ${isActive("/services") ? "font-bold text-primary-base" : ""} hover:text-primary-base`}>Services</Link>
      ...
      {isMobileMenuOpen && (
        ...
        <nav className="md:hidden bg-black text-white">
          <ul className="flex flex-col space-y-4 p-4">
            <li>
              <Link href="/services" className={`hover:text-primary-base ${isActive("/services") ? "font-bold text-primary-base" : ""}`} onClick={toggleMobileMenu}>Services</Link>
            </li>
            <li>
              <Link href="/case-studies" className={`${isActive("/case-studies") ? "font-bold text-primary-base" : ""} hover:text-primary-base`} onClick={toggleMobileMenu}>Works</Link>
            </li>
            <Link href="/about-us" className={`${isActive("/about-us") ? "font-bold text-primary-base" : ""} hover:text-primary-base`} onClick={toggleMobileMenu}>About</Link>
            <li>
            <Link  href="/contact" className={`${isActive("/contact") ? "font-bold text-primary-base" : ""} hover:text-white text-silver-50 px-4 py-2 hover:bg-primary-300 bg-primary-base rounded-md`} onClick={toggleMobileMenu}>Contact</Link>
            </li>
            <li>
              <Link href="/career" className="hover:text-primary-base" onClick={toggleMobileMenu}>Career</Link>
            </li>
            {/* <div className='cursor-pointer' onClick={()=>setContactModalOpen(!isContactModalOpen)}><FaPhoneVolume /></div> */}
            {/* <li>
