...
const ContactForm = () => {
  ...
  return (
    <div className=' text-dark flex flex-col gap-3 sm:gap-6 lg:gap-12 md:flex-row max-w-[1200px] px-4 mx-auto'>
      ...
      <div className="flex justify-start overflow-x-auto  border-b-[1px] mx-8 border-silver-100 relative space-x-4 scrollbar-hide">
          {tabs.map((tab) => (
            <button
              key={tab.id}
...
<InputField
      ...
      />
          ...
          <div className="mt-6 text-center text-[#4b5563]">
            <p className="mb-1">
              <strong>Email:</strong> sales@codecreador.com
            </p>
            <p>
              <strong>Phone (India):</strong> +91 9822235937 </p>
            <p>  <strong>Phone (U.S):</strong> +1(213)935-7997
            {/* <p>  <strong>Phone (U.S):</strong> +1 (213)497-1057 */}
            </p>
